    ...
    <div class="col-lg-12">
        <div class="portlet box">
            <div class="portlet-title bg-primary">
                <div class="caption">
                    <span><i class="fa fa-search"></i> Tìm kiếm Điểm giữ xe</span>
                </div>
            </div>
            <div class="portlet-body">
                <?php $form = ActiveForm::begin() ?>
                <div class="col-lg-6">
                    <?= $form->field($model['search'], 'ten_diemgiuxe', ['inputOptions' => ['autofocus' => 'autofocus']])->input('text')->label('Tên điểm giữ xe') ?>
                </div>
                <div class="col-lg-6">
