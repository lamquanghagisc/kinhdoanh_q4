...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <span class="active">Cập nhật Điểm giữ xe</span>
    </li>
</ul>
    ...
    <div class="col-lg-12">
        <div class="portlet light">
            <div class="portlet-title">
                <div class="caption">
                    <span class="font-blue-steel">Cập nhật Điểm giữ xe</span>
                </div>
            ...
            <div class="portlet-body">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-danger pull-left"
                       href="<?= Yii::$app->urlManager->createUrl('diemgiuxe/view') . '?id=' . $model['diemgiuxe']['id_diemgiuxe'] ?>">Huỷ</a>
