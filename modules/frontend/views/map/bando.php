...
<div class="content-full-width padding-tb-05">
    <div class="row-map">
        <div class="col-md-3">
            <div class="block">
                <ul class="nav nav-tabs nav-tabs-alt">
                    <li class="nav-item"><a class="nav-link active" data-toggle="tab" href="#thongke">Tra cứu vị trí</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#hokinhdoanh">Hộ kinh doanh</a>
                    </li>
                    <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#doanhnghiep">Doanh nghiệp</a></li>
                </ul>
                <div class="block-content tab-content">
                        ...
                        <div class="portlet-title">
                            <div class="col-lg-12">
                                <div class="caption" style='width: 100%; padding-top: 7px'>
                                    <input class="form-control" id='search-box'
                                           placeholder='Nhập thông tin hộ kinh doanh'>
                    ...
                    <div class="tab-pane " id="doanhnghiep">
                        <div class="portlet-title">
                            <div class="col-lg-12">
                                <div class="caption" style='width: 100%; padding-top: 7px'>
                                    <input class="form-control" id='search-boxdn'
                                           placeholder='Nhập thông tin doanh nghiệp'>
                                    <span class="caption-subject font-dark bold uppercase"></span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane active" id="thongke">
                        <div class="portlet-body">
                            <div class="col-lg-12 form-group">
                                ...
                                <input type="text" id='geocomplete' class="form-control input-circle"
                                       placeholder="Nhập vị trí cần tìm..." required>

                                <div class="col-md-6">

                                    <input class="form-control input-circle hidden" type="text" name="ToaDo[geo_x]"
                                           id="geo_x" value="0">
                                </div>
                                <div class="col-md-6">

                                    <input class="form-control input-circle hidden" type="text" name="ToaDo[geo_y]"
                                           id="geo_y" value="0">
                                </div>
                            ...
                            <div class="col-lg-12 form-group">
                                <button type="submit" id="cgsearch_btn" class="btn input-circle btn-info pull-right"
                                        onclick="initTracuu()"><i class="fa fa-search"></i> Tra cứu
                                </button>
                            </div>
                        </div>
        ...
        <div class="col-md-9">
            <div class="block">
                <div class="block-content">
                    <div class="margin-tb-05">
                        <div class="btn-group float-right">
                            <select class="form-control" id="cboDuong">
                            ...
                            <select class="form-control" id="cboLv">
                    ...
                    <div id="map" class="gmaps margin-tb-05"></div>
                </div>
            </div>
        </div>
    </div>
...
//                    });
    ...
    function initFocusCircleLayer(config) {
        DATA.MapLayer.focuscirclelayer = L.circleMarker([0, 0], {
