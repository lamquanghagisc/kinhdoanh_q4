...
/* @var $searchModel app\modules\backend\models\SearchKhoSanPham */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Kho';
$this->params['breadcrumbs'][] = $this->title;

DCrudAsset::register($this);

?>
<div class="kho-san-pham-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Kho','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
