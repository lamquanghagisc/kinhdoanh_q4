...
/* @var $searchModel app\modules\backend\models\SearchKhachHang */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Khách hàng';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Khách hàng','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
