...
/* @var $searchModel app\modules\backend\models\categories\SearchLoaiSanPham */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Loại sản phẩm';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Loại sản phẩm','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
