...
/* @var $searchModel app\modules\backend\models\categories\SearchSanPham */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Sản phẩm';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Sản phẩm','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
