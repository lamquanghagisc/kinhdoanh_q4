...
/* @var $searchModel app\modules\backend\models\categories\SearchNhomSanPham */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Nhóm sản phẩm';
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Nhóm sản phẩm','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
