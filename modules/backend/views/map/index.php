...
<script>
    ...
    function initHokinhdoanhGeojsonLayer(config) {
        $.ajax({
            url: DATA.HomeUrl + 'map/hokinhdoanh-geojson',
            dataType: 'json',
...
//                        $.ajax({
//                            url: DATA.HomeUrl + 'map/hokinhdoanh-get/?slug=' + data.id,
...
//                    });
    ...
    function initDoanhnghiepGeojsonLayer(config) {
        ...
        $.ajax({
            url: DATA.HomeUrl + 'map/doanhnghiep-geojson',
            dataType: 'json',
            success: function (data) {
                var pruneCluster = new PruneClusterForLeaflet();
                data.map(function (item) {
...
//                        //   mapZoomAndPanTo(data.geo_y, data.geo_x);
//                        $.ajax({
//                            url: DATA.HomeUrl + 'map/doanhnghiep-get/?slug=' + data.id,
//                            success: function (html) {
//                                $('#' + popupid).empty().append(html);
//                            }
//                        })
...
//                    });
    ...
    function callHokinhdoanhInCircle(lat, lng, radius) {
        $.ajax({
            url: DATA.HomeUrl + 'map/hokinhdoanh-incircle?lat={0}&lng={1}&radius={2}'.replace('{0}', lat).replace('{1}', lng).replace('{2}', radius),
            success: function (html) {
