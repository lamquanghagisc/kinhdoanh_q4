...
/* @var $searchModel app\models\DmLoaitinSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = (isset($const['title'])) ? $const['title'] : 'Loại tin';
$this->params['breadcrumbs'][] = $this->title;

DCrudAsset::register($this);

?>
<div class="dm-loaitin-index">
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ...
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Thêm mới Loại tin','class'=>'btn btn-success'])
                ],
            ],          
            'striped' => true,
            'condensed' => true,
