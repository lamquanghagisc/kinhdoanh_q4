...
// $this->title = (isset($const['title'])) ? $const['title'] : 'Tin tức';
$this->title = $const['label']['index'] . ' ' . $const['title'];
...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="<?= Yii::$app->urlManager->createUrl('tintuc/tintuc') ?>">Tin tức</a>
    </li>
                ...
                <?=GridView::widget([
                    ...
                    'toolbar'=> [
                        ...
                        ['content'=>$const['buttons']['create'],
                            ...
                            // ['role'=>'modal-remote','title'=> 'Thêm mới Tin tức','class'=>'btn btn-success'])
                        ],
                    ],          
                    'striped' => true,
                    'condensed' => true,
