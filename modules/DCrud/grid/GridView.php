...
namespace app\modules\DCrud\grid;

use app\services\DebugService;
use app\modules\DCrud\Module;
...
//        DebugService::dumpdie($out);
    ...
    protected function renderToolbarContainer()
    {
        ...
        if (!isset($this->toolbarContainerOptions['class'])) {
            return Html::tag($tag, $this->renderToolbar(), $this->toolbarContainerOptions);
        } else {
            Html::addCssClass($this->toolbarContainerOptions, 'float-right');
            return Html::tag($tag, $this->renderToolbar(), ['class' => 'float-right']);
        }
    }
