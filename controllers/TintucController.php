...
class TintucController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "<b>Thêm mới TinTuc</b>",
                    'content'=>'<span class="text-success">Thêm mới TinTuc thành công</span>',
                    'footer'=> Html::button('Đóng',['class'=>'btn btn-default pull-right','data-dismiss'=>"modal"]).
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing TinTuc model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
