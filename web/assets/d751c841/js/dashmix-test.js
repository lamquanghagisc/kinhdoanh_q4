...
!(function () {
                            ...
                            jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function (e, a) {
                                ...
                                t.addClass("js-click-ripple-enabled")
                                    ...
                                    .on("click.pixelcave.helpers.core", function (e) {
                                        ...
                                        (a = t.children("." + l)).height() || a.width() || ((o = Math.max(t.outerWidth(), t.outerHeight())), a.css({ height: o, width: o })),
                        ...
                        value: function () {
                            ...
                            jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function (a, t) {
                                    ...
                                    s = {
                                        line: function () {
                                            (i.type = l),
                                                ...
                                                (i.minSpotColor = r.data("min-spot-color") || "#495057"),
                                                (i.maxSpotColor = r.data("max-spot-color") || "#495057"),
                                                (i.highlightSpotColor = r.data("highlight-spot-color") || "#495057"),
                                                (i.highlightLineColor = r.data("highlight-line-color") || "#495057"),
                                ...
                                s[l]
                                    ? (s[l](),
                                    "line" === l &&
                                    ((r.data("chart-range-min") >= 0 || r.data("chart-range-min")) && (i.chartRangeMin = r.data("chart-range-min")),
                                    (r.data("chart-range-max") >= 0 || r.data("chart-range-max")) && (i.chartRangeMax = r.data("chart-range-max"))),
                                        (i.width = r.data("width") || "120px"),
                                        (i.height = r.data("height") || "80px"),
                                        (i.tooltipPrefix = r.data("tooltip-prefix") ? r.data("tooltip-prefix") + " " : ""),
                                        (i.tooltipSuffix = r.data("tooltip-suffix") ? " " + r.data("tooltip-suffix") : ""),
                                        "100%" === i.width
                                            ? n ||
                                            ((n = !0),
    ...
    var u = (function (e) {
        !(function (e, a) {
            ...
            (e.prototype = Object.create(a && a.prototype, { constructor: { value: e, writable: !0, configurable: !0 } })), a && s(e, a);
        })(n, e);
        var a,
            t,
            o =
                            ...
                            this._lPage.off("click.pixelcave.menu"),
                                this._lPage.on("click.pixelcave.menu", '[data-toggle="submenu"]', function (e) {
                                    ...
                                    if (!(a.getWidth() > 991 && t.parents(".nav-main").hasClass("nav-main-horizontal nav-main-hover"))) {
                                        var o = t.parent("li");
                                        o.hasClass("open") ? (o.removeClass("open"), t.attr("aria-expanded", "false")) : (t.closest("ul").children("li").removeClass("open"), o.addClass("open"), t.attr("aria-expanded", "true")),
                                            t.trigger("blur");
                                    }
                                    return !1;
                                });
                    ...
                    },
                    {
                        ...
                        value: function () {
                            ...
                            jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"),
                                ...
                                this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function (o) {
                                    o.preventDefault();
                                    ...
                                    jQuery('[data-toggle="theme"]').removeClass("active"),
                                        ...
                                        a.updateTheme(e, r),
                                        (e = jQuery("#css-theme")),
                                    t && Cookies.set("dashmixThemeName", r, { expires: 7 }),
                                        n.trigger("blur");
                                });
                        },
                    },
                            ...
                            var o = {
                                init: function () {
                                    t._lPage.off("click.pixelcave.layout"),
                                        ...
                                        t._lPage.on("click.pixelcave.layout", '[data-toggle="layout"]', function (e) {
                                            var a = jQuery(e.currentTarget);
